    ...
    Bool_t save_gen)
{
    ...
    while (reader.Next())
    {
        ...
        DC_region1_y.clear();
        DC_region1_z.clear();
        DC_region1_edge.clear();
        DC_region2_x.clear();
        DC_region2_y.clear();
        DC_region2_z.clear();
        DC_region2_edge.clear();
        DC_region3_x.clear();
        DC_region3_y.clear();
        DC_region3_z.clear();
        DC_region3_edge.clear();
        PCAL_x.clear();
        PCAL_y.clear();
        PCAL_z.clear();
        PCAL_edge.clear();
        ...
        for (int i = 0; i < num_tracks; i++)
        {
            ...
            {
                if ((int)ftrack_pindex_branch[j] != particle_i)
                    continue;
            ...
            {
                if ((int)calo_pindex_branch[j] != particle_i)
                    continue;
            ...
            {
                if ((int)cherenkov_pindex_branch[j] != particle_i)
                    continue;
            ...
            {
                if ((int)trajectory_pindex_branch[j] != particle_i)
                    continue;
            ...
            for (std::size_t j = 0; j < trajectory_pindex_branch.GetSize(); j++)
            {
                ...
                if (detector_number != 7 || layer_number != 1)
                    continue; // only PCAL
    ...
    if (save_gen)
    {
        ...
        while (reader.Next())
        {
            ...
            gen_theta.clear();
            gen_phi.clear();
            gen_theta_degrees.clear();
            gen_phi_degrees.clear();
